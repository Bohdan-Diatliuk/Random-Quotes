...
const products = [
  { name: 'BOSE', description: 'BOSE is a responsive web page, clean minimal design, low complexity, fast loading.', href: 'https://bdtlk-bose-web.netlify.app/', icon: ChartPieIcon },
  { name: 'MYBIKE', description: 'MYBIKE is a modern website about bicycles, built with HTML5 and SCSS. ', href: 'https://bohdan-diatliuk.github.io/layout_landing-page/', icon: CursorArrowRaysIcon },
  { name: '2048', description: 'soon...', href: '#', icon: FingerPrintIcon },
]
const callsToAction = [
  { name: 'Telegram', href: '#', icon: PlayCircleIcon },
  { name: 'LinkedIn', href: '#', icon: PhoneIcon },
]
      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <img
              alt=""
              src="https://i.pinimg.com/736x/24/94/21/249421f9be85c3865eb87877181e79f8.jpg"
              className="h-12"
            />
          </a>
        </div>
